...
- Ex 13: Modify Binary_tree to take a parameter to indicate what kind of line to
use to connect the nodes.*/
...
{
    public:
        Binary_tree(int ll, int rr, Line_style llss);
...
Binary_tree::Binary_tree(int ll, int rr, Line_style llss)
                        : lv{ll}, r{rr}, ls{llss}
{
    int circles{1};
    int inc_x;
...
int main()
{
	...
	Point tl{100,100};
	Simple_window win{tl,sw,sh,"Chapter 14 - EX1413"};

    Binary_tree bt{6,20,Line_style::dashdot};
    win.attach(bt);
