/*Modify reserve to use the unique_ptr based solution.*/
...
// Growth. reserve() using unique_ptr.

template<typename T, typename A>
void vector<T,A>::reserve(int newalloc)
{
    if(newalloc <= capacity()) return;
    unique_ptr<vector_base<T,A>> b{new vector_base<T,A>{this->alloc,newalloc}};
