/*Implementation of vector class using template parameters.*/
...
public:
    ...
    ~vector() { alloc.deallocate(elem,space);} //delete[] elem; }            // Destructor. 
...
int main()
{
    ...
    cout << "\n\n\tChecking copy.\n\t";
    v::vector<int> t1{10,15};                   t1.push_back(300);
    ...
    t3 = test<int,allocator<int>>(5);          t3.resize(10,88);
    for(int i=0; i<t3.size(); ++i)
        cout << "\n\t" << t3[i] << "\t";
