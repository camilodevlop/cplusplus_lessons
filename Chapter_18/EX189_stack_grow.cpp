/*Write a program that tells the order in which static storage, the
stack, and the free store are laid out in memory. In which direcction 
does the stack grow: up (toward higher addresses) or down
(toward lower addresses)? In an array of the free store, are elements
...
int main()
{
    ...
    cout << "\n\n\tAddresses of the elements in an array:";
    for(int i=0; i<9; ++i)
        cout << "\n\tch[" << i << "]: " << &ch[i];
